...
| Calibration Capability                          | Manual one-time calibration          | Automatic calibration on startup    | No                                  |
| IMU Sensor                                      | 3-axis (gyroscope)                   | 6-axis (accelerometer + gyroscope)  | No                                  |
| Orientation Accuracy                            | Direction of motion                  | ±5 degrees for pitch/roll           | No                                  |
